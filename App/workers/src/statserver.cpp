...
StatServer::StatServer(HCore::HCore *core) :
    Threadable(5,"Stat",true,core){
}


void StatServer::pushStat(std::string stat){
    m_stats[stat].counter++;
}


float StatServer::getStat(std::string stat){
